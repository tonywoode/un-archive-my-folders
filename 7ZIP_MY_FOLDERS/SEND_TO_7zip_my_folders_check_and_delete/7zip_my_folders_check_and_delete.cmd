...
::	This script will 7zip folders, then check them, then delete the source
...
rd /s /q %folder% 2>&1
set error=%errorlevel%
if %error% EQU 0 echo.%shortfolder% DELETED from %folderdir% AS 7z TESTED OK | "%scriptdir%/mtee.exe" /+ %log%
